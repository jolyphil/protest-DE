...
* Data: ESS round 1- 2002, ESS round 2 - 2004 or ESS round 3 - 2006
* May 2014
...
**** Data file format: SPSS (.sav) saved as Stata version 8 SE (.dta)
...
recode iscocop (66666 77777 88888 99999=-9), copyrest gen(isco_partner)
...
recode emprelp (6 7 8 9=9), copyrest gen(emplrel_p)
replace emplrel_p=-9 if cntry=="FR" & (essround==1 | essround==2) // Replace this command line with [SYNTAX B] or [SYNTAX D]
...
recode emplnop (0 66666 77777 88888 99999=0)(1/9=1)(10/10000=2), gen(emplno_p)
...
**** In order to construct the Oesch class schema for France in ESS round 1 (2002) and ESS round 2 (2004) or/and Hungary in ESS round 2 (2004):
...
**** ESS round 1 - 2002
  ...
  ** SYNTAX A (France - respondent):
  /* recode emprlfr (2 3 4=1)(1=2)(5=3)(6 8 9=9)
  /* replace emplrel_r=emprlfr if cntry=="FR" & essround==1

  ** SYNTAX B (France - partner):
  /* recode emprlpfr (2 3 4=1)(1=2)(5=3)(6 8 9=9)
  /* replace emplrel_p=emprlpfr if cntry=="FR" & essround==1
  
**** ESS round 2 - 2004

  ** SYNTAX C (France - respondent):
  /* recode emprlfr (2 3 4=1)(1=2)(5=3)(6 8 9=9)
  /* replace emplrel_r=emprlfr if cntry=="FR" & essround==2

  ** SYNTAX D (France - partner):
  /* recode emprlpfr (2 3 4=1)(1=2)(5=3)(6 8 9=9)
  /* replace emplrel_p=emprlpfr if cntry=="FR" & essround==2
